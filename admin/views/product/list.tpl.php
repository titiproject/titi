...
<div id="content">
    ...
    <div id="main-content">
        <div id="title"><span><?php echo $title; ?></span><a class="button" href="index.php?controller=product&action=add"><i class="fa fa-plus fa-lg"></i>&nbsp;Add New</a></div>
        <div id="table">
            ...
            <?php showTBodyProducts($proList,$catList, $cusList);?>
                <tr>
                    <th><input type="checkbox" /></th>
                    <th>id</th>
                    <th>name</th>
