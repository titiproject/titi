            ...
            <div id="featured">
                <div id="accordion">
                    <dl class="easy-accordion">
                        ...
                        <dd style="width: 470px; height: 193px; left: 92px; display: none;" class=""><h2>Here is the second slide</h2><p><img alt="Alt text to go here" src="images/post-images/img2.png">Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, enim.<br><a class="more" href="#">Read more</a></p></dd>
                        ...
                        <dd style="width: 470px; height: 193px; left: 138px; display: none;" class=""><h2>One more slide to go here</h2><p><img alt="Alt text to go here" src="images/post-images/img3.png">Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, enim.<br><a class="more" href="#">Read more</a></p></dd>
                        ...
                        <dd style="width: 470px; height: 193px; left: 184px; display: none;" class=""><h2>Another slide to go here</h2><p><img alt="Alt text to go here" src="images/post-images/img4.png">Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, enim.<br><a class="more" href="#">Read more</a></p></dd>
                        ...
                        <dd style="width: 470px; height: 193px; left: 230px; display: none;" class="no-more-active"><h2>Unbilievable one more slide here</h2><p><img alt="Alt text to go here" src="images/post-images/img5.png">Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, enim.<br><a class="more" href="#">Read more</a></p></dd>
                        ...
                        <dd style="width: 470px; height: 193px; left: 276px; display: block;" class="active"><h2>This is definitely the last one</h2><p><img alt="Alt text to go here" src="images/post-images/img6.png">Cum sociis natoque penatibus et magnis dis post-images montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, enim.<br><a class="more" href="#">Read more</a></p></dd>
                    </dl>
                </div>
            </div><!-- end featured -->
